## Nmap
```bash
# Nmap 7.91 scan initiated Wed Jun  9 14:49:18 2021 as: nmap -p 21,22,80, -sC -sV -oA nmap/final 10.10.10.245
...
|     Server: gunicorn
|     Date: Wed, 09 Jun 2021 20:00:37 GMT
|     Connection: close
...
|     HTTP/1.0 200 OK
|     Server: gunicorn
|     Date: Wed, 09 Jun 2021 20:00:32 GMT
|     Connection: close
|     Content-Type: text/html; charset=utf-8
...
SF-Port80-TCP:V=7.91%I=7%D=6/9%Time=60C11B45%P=x86_64-pc-linux-gnu%r(GetRe
SF:quest,2AA4,"HTTP/1\.0\x20200\x20OK\r\nServer:\x20gunicorn\r\nDate:\x20W
SF:ed,\x2009\x20Jun\x202021\x2020:00:32\x20GMT\r\nConnection:\x20close\r\n
...
SF:09\x20Jun\x202021\x2020:00:32\x20GMT\r\nConnection:\x20close\r\nContent
...
SF:d,\x2009\x20Jun\x202021\x2020:00:37\x20GMT\r\nConnection:\x20close\r\nC
...
# Nmap done at Wed Jun  9 14:51:29 2021 -- 1 IP address (1 host up) scanned in 131.30 seconds

```
* Checking out the website and some of the pages found on it, one that sticks out is the *Security Snapshot* page
	* The interesting part is the url, which is /data/2
![[Pasted image 20210616141307.png]]
* See that when you hit the download button, it redirects you to a page called /download/n 
	* n is the same number that was in the /data/n url
* Capture the download request of index 0 with burpsuite and find some creds:
![[Pasted image 20210616141633.png]]
