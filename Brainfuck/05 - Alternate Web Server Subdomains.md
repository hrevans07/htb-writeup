...
![[Pasted image 20210523131213.png]]
* Found page https://sup3rs3cr3t.brainfuck.htb/api/users that leaks usernames
	* admin
	* orestis
	* kostas

![[Pasted image 20210523133233.png]]

## brainfuck.htb
![[Pasted image 20210523134700.png]]
* Site is using wordpress
* Use wpscan to do some enumeraton on wordpress
```bash
...
[32m[+][0m Started: Wed May 26 15:45:09 2021
...
[32m[+][0m WordPress version 4.7.3 identified (Insecure, released on 2017-03-06).
 ...
 |
 | [31m[!][0m 52 vulnerabilities identified:
 |
...
[32m[+][0m WordPress theme in use: proficient
 ...
 | [33m[!][0m The version is out of date, the latest version is 3.0.45
...
[32m[+][0m wp-support-plus-responsive-ticket-system
 ...
 |
 | [31m[!][0m Title: WP Support Plus Responsive Ticket System < 8.0.0 – Authenticated SQL Injection
 |     Fixed in: 8.0.0
 |     References:
 ...
 |
 | [31m[!][0m Title: WP Support Plus Responsive Ticket System < 8.0.8 - Remote Code Execution (RCE)
 |     Fixed in: 8.0.8
 |     References:
 ...
 |
 | [31m[!][0m Title: WP Support Plus Responsive Ticket System < 9.0.3 - Multiple Authenticated SQL Injection
 |     Fixed in: 9.0.3
 |     References:
 ...
 |
 | [31m[!][0m Title: WP Support Plus Responsive Ticket System < 9.1.2 - Stored XSS
 |     Fixed in: 9.1.2
 |     References:
 ...
 |
 | [31m[!][0m Title: WP Support Plus Responsive Ticket System < 8.0.0 - Privilege Escalation
 |     Fixed in: 8.0.0
 |     References:
 ...
 |
 | [31m[!][0m Title: WP Support Plus Responsive Ticket System < 8.0.8 - Remote Code Execution
 |     Fixed in: 8.0.8
 |     References:
...
[32m[+][0m Finished: Wed May 26 15:46:32 2021
[32m[+][0m Requests Done: 3249
[32m[+][0m Cached Requests: 64
[32m[+][0m Data Sent: 900.494 KB
[32m[+][0m Data Received: 557.575 KB
[32m[+][0m Memory used: 262.289 MB
[32m[+][0m Elapsed time: 00:01:22
```
* wpscan finds that its running wordpress version 4.7.3
* It is WP Support Plus, not default wordpress - version 7.1.3
* Run searchsploit wp support plus and find a priv escalation exploit
```html
...
```
* Submit form and you now have admin cookie
* Go to dashboard -> settings -> Easy WP SMTP
* Get user orestis's smtp password
* Log into orestis email account and find 2 emails, one from root
![[Pasted image 20210526173431.png]]
